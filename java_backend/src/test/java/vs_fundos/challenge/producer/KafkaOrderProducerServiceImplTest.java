...
public class KafkaOrderProducerServiceImplTest {
    ...
    void SetUp() {
        try {
            java.lang.reflect.Field topicNameField = KafkaOrderProducerServiceImpl.class.getDeclaredField("topicName");
            topicNameField.setAccessible(true);
            topicNameField.set(kafkaOrderProducerServiceImpl, TEST_TOPIC_NAME);
        } catch (Exception e) {
